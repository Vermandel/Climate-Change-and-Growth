...
residual = zeros(19, 1);
    ...
    residual(7) = (y(26)) - (1-params(33)+params(33)*y(7)+x(it_, 1));
    residual(8) = (y(17)) - (T(4)*((1+y(27))*y(28)/y(16))^params(7));
    residual(9) = (y(18)) - (T(5)*T(6));
    residual(10) = (y(15)) - (y(19)*y(26)*y(21));
    residual(11) = (y(18)) - (y(26)*y(21)*(1-y(12)*(params(22)*y(22)*(1-y(20))+T(7))));
